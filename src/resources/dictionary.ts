...
// 国际考试
const internationalExam2: DictionaryResource[] = [
  {
    id: 'ielts_disorder',
    name: 'IELTS Disorder Version',
    description: 'IELTS disorder version',
    category: '国际考试',
    tags: ['IELTS'],
  ...
  },
  {
    id: 'ielts',
    name: 'IELTS',
    description: 'IELTS Core Vocabulary',
    category: '国际考试',
    tags: ['IELTS'],
...
const programming2: DictionaryResource[] = [
  {
    id: 'jsArray',
    name: 'JS: Array',
    description: 'JavaScript API Dict',
    category: '代码练习',
    tags: ['JavaScript'],
  ...
  {
    id: 'sql-lower-case',
    name: 'SQL: Common lower case',
    description: 'SQL common lower case',
    category: '代码练习',
    tags: ['SQL'],
  ...
  {
    id: 'sql-upper-case',
    name: 'SQL: Common upper case',
    description: 'SQL common upper case',
    category: '代码练习',
    tags: ['SQL'],
  ...
  },
  {
    ...
    description: 'AI machine learning common words',
    category: '代码练习',
    tags: ['AI'],
  ...
  },
  {
    ...
    name: 'AI for Science',
    description: 'AI for Science common words',
    category: '代码练习',
    tags: ['AI'],
